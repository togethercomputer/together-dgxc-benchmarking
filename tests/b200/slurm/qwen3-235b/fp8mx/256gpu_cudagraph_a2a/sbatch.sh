...
# Experiment 3a: CUDA graphs + MoE A2A overlap
# Baseline with CUDA graphs: 45.6s/step, 425 TFLOP/s/GPU (job 80084)
#

# Parameters
#SBATCH --account=root
#SBATCH --exclusive
#SBATCH --job-name=qwen3_fp8mx_cg_a2a
#SBATCH --mem=0
#SBATCH --nodes=32
#SBATCH --ntasks-per-node=8
#SBATCH --open-mode=append
#SBATCH --output=/mnt/vast/johnson/scripts/qwen3_235b_fp8mx_cudagraph_a2a/sbatch_%j.out
...
srun \
  ...
  --container-writable \
  bash /mnt/vast/johnson/scripts/qwen3_235b_fp8mx_cudagraph_a2a/run.sh
