...
# Experiment 2: CUDA graphs + HybridEP dispatcher
...
#SBATCH --account=root
#SBATCH --exclusive
#SBATCH --job-name=qwen3_235b_fp8mx_cudagraph_hybridep
#SBATCH --mem=0
#SBATCH --nodes=32
#SBATCH --ntasks-per-node=8
#SBATCH --open-mode=append
#SBATCH --output=/mnt/vast/johnson/scripts/qwen3_235b_fp8mx_cudagraph_hybridep/sbatch_%j.out
...
srun \
  ...
  --container-writable \
  bash /mnt/vast/johnson/scripts/qwen3_235b_fp8mx_cudagraph_hybridep/run.sh
