...
#SBATCH --account=root
#SBATCH --exclusive
#SBATCH --job-name=root-root.pretrain_qwen3_30b_a3b_fp8_mx_gpus64_tp1_pp1_cp1_vpNone_ep8_mbs1_gbs4096
#SBATCH --mem=0
#SBATCH --nodes=8
#SBATCH --ntasks-per-node=8
#SBATCH --open-mode=append
#SBATCH --output=/mnt/vast/exemplar/llmb/workloads/pretrain_qwen3/experiments/pretrain_qwen3_30b_a3b_fp8_mx_gpus64_tp1_pp1_cp1_vpNone_ep8_mbs1_gbs4096/pretrain_qwen3_30b_a3b_fp8_mx_gpus64_tp1_pp1_cp1_vpNone_ep8_mbs1_gbs4096_1775694978/pretrain_qwen3_30b_a3b_fp8_mx_gpus64_tp1_pp1_cp1_vpNone_ep8_mbs1_gbs4096/sbatch_root-root.pretrain_qwen3_30b_a3b_fp8_mx_gpus64_tp1_pp1_cp1_vpNone_ep8_mbs1_gbs4096_%j.out
...
srun --output /mnt/vast/exemplar/llmb/workloads/pretrain_qwen3/experiments/pretrain_qwen3_30b_a3b_fp8_mx_gpus64_tp1_pp1_cp1_vpNone_ep8_mbs1_gbs4096/pretrain_qwen3_30b_a3b_fp8_mx_gpus64_tp1_pp1_cp1_vpNone_ep8_mbs1_gbs4096_1775694978/pretrain_qwen3_30b_a3b_fp8_mx_gpus64_tp1_pp1_cp1_vpNone_ep8_mbs1_gbs4096/log-root-root.pretrain_qwen3_30b_a3b_fp8_mx_gpus64_tp1_pp1_cp1_vpNone_ep8_mbs1_gbs4096_%j_${SLURM_RESTART_COUNT:-0}.out --container-image /mnt/vast/exemplar/llmb/images/nvidia+nemo+25.11.01.sqsh --container-mounts /mnt/vast/exemplar/llmb/workloads/pretrain_qwen3:/mnt/vast/exemplar/llmb/workloads/pretrain_qwen3,/mnt/vast/exemplar/llmb/.cache/huggingface,/mnt/vast/exemplar/llmb/workloads/pretrain_qwen3/Megatron-Bridge/scripts/performance/run_script.py:/mnt/vast/exemplar/llmb/workloads/pretrain_qwen3/Megatron-Bridge/scripts/performance/run_script.py,/mnt/vast/exemplar/llmb/workloads/pretrain_qwen3/Megatron-Bridge/scripts/performance:/mnt/vast/exemplar/llmb/workloads/pretrain_qwen3/Megatron-Bridge/scripts/performance,/mnt/vast/exemplar/llmb/workloads/pretrain_qwen3/experiments/pretrain_qwen3_30b_a3b_fp8_mx_gpus64_tp1_pp1_cp1_vpNone_ep8_mbs1_gbs4096/pretrain_qwen3_30b_a3b_fp8_mx_gpus64_tp1_pp1_cp1_vpNone_ep8_mbs1_gbs4096_1775694978/pretrain_qwen3_30b_a3b_fp8_mx_gpus64_tp1_pp1_cp1_vpNone_ep8_mbs1_gbs4096:/nemo_run --container-workdir /nemo_run/code --wait=60 --kill-on-bad-exit=1 --mpi=pmix --no-container-mount-home --container-writable bash /nemo_run/scripts/pretrain_qwen3_30b_a3b_fp8_mx_gpus64_tp1_pp1_cp1_vpNone_ep8_mbs1_gbs4096.sh
