#!/bin/bash
#
# OFFICIAL NVIDIA BASELINE — Nemotron-H 56B FP8 — 512 GPUs (64 nodes)
# Source: https://github.com/NVIDIA/dgxc-benchmarking/blob/main/nemotron-h/README.md
#
# B200 Config: TP=2, MBS=1, GBS=1536 (512*3), FP8 recipe=cs
...
echo "=== Nemotron-H 56B FP8 — 512 GPU — NVIDIA Official Baseline ==="
echo "Config: TP=2, MBS=1, GBS=1536, FP8_RECIPE=cs"
echo ""
