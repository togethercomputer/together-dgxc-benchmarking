#!/bin/bash
#
# Nemotron4 15B FP8 - 256 GPUs - EXPERIMENT 6: GBS=2048
# Rationale: With GBS=2048, each DP rank processes 4 microbatches (MBS=2).
# More gradient accumulation = more compute to overlap with allreduce.
# Current best (GBS=1024): 1,785 TFLOPS/GPU. Target: 1,908.
#

# Parameters
#SBATCH --account=root
#SBATCH --exclusive
#SBATCH --job-name=nem15b_fp8_256gpu_exp6_gbs2048
#SBATCH --mem=0
#SBATCH --nodes=32
#SBATCH --ntasks-per-node=8
#SBATCH --open-mode=append
#SBATCH --output=/mnt/vast/johnson/llmb/workloads/pretrain_nemotron4-15b/experiments/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512_1776133053/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/sbatch_exp6_gbs2048_%j.out
...
# EXPERIMENT 6: GBS=2048 (4 microbatches per DP rank)
...
# Command 1
srun --output /mnt/vast/johnson/llmb/workloads/pretrain_nemotron4-15b/experiments/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512_1776133053/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/log-exp6_gbs2048_%j_${SLURM_RESTART_COUNT:-0}.out \
