#!/bin/bash
#
# Nemotron4 15B FP8 - 256 GPUs - EXPERIMENT 3: TP=2 + GBS=1024
# Rationale: Combines smaller DP ring (128 GPUs) with more microbatches per rank.
# With TP=2, DP=128, MBS=2, GBS=1024: 1024/(128*2) = 4 microbatches per DP rank.
# Excellent compute/comm overlap.
# Baseline (TP=1, GBS=512): ~1,600 TFLOPS/GPU. Expected: 20-30% improvement.
#

# Parameters
#SBATCH --account=root
#SBATCH --exclusive
#SBATCH --job-name=nem15b_fp8_256gpu_exp3_tp2_gbs1024
#SBATCH --mem=0
#SBATCH --nodes=32
#SBATCH --ntasks-per-node=8
#SBATCH --open-mode=append
#SBATCH --output=/mnt/vast/johnson/llmb/workloads/pretrain_nemotron4-15b/experiments/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512_1776133053/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/sbatch_exp3_tp2_gbs1024_%j.out
...
# EXPERIMENT 3: TP=2 + GBS=1024
# DP=128, MBS=2, GBS=1024 => 4 microbatches per DP rank
export OVERRIDE_GBS=1024
export OVERRIDE_NUM_TRAIN_SAMPLES=51200
...
# Command 1
srun --output /mnt/vast/johnson/llmb/workloads/pretrain_nemotron4-15b/experiments/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512_1776133053/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/log-exp3_tp2_gbs1024_%j_${SLURM_RESTART_COUNT:-0}.out \
