#!/bin/bash
#
# Nemotron4 15B FP8 - 256 GPUs - EXPERIMENT 4: NCCL NVLS Enable
# Rationale: NCCL_NVLS_ENABLE=0 was set in baseline. NVLink-SHARP (NVLS)
# can accelerate intra-node reduction using NVLink multicast on B200.
# Baseline (NVLS off): ~1,600 TFLOPS/GPU. Expected: 2-5% improvement.
#

# Parameters
#SBATCH --account=root
#SBATCH --exclusive
#SBATCH --job-name=nem15b_fp8_256gpu_exp4_nvls
#SBATCH --mem=0
#SBATCH --nodes=32
#SBATCH --ntasks-per-node=8
#SBATCH --open-mode=append
#SBATCH --output=/mnt/vast/johnson/llmb/workloads/pretrain_nemotron4-15b/experiments/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512_1776133053/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/sbatch_exp4_nvls_%j.out
...
# Same GBS as baseline
export OVERRIDE_GBS=512
export OVERRIDE_NUM_TRAIN_SAMPLES=25600

# EXPERIMENT 4: Enable NCCL NVLS (NVLink-SHARP)
...
# Command 1
srun --output /mnt/vast/johnson/llmb/workloads/pretrain_nemotron4-15b/experiments/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512_1776133053/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/log-exp4_nvls_%j_${SLURM_RESTART_COUNT:-0}.out \
