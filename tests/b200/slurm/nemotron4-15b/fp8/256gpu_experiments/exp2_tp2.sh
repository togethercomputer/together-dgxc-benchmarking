#!/bin/bash
#
# Nemotron4 15B FP8 - 256 GPUs - EXPERIMENT 2: TP=2
# Rationale: TP=2 uses NVLink for intra-node tensor-parallel allreduce (fast)
# while cutting DP world size from 256 to 128. Halves NCCL ReduceScatter/AllGather
# data volume and ring size. With 128 DP ranks and MBS=2, GBS=512 gives
# 512/(128*2) = 2 microbatches per DP rank.
# Baseline (TP=1): ~1,600 TFLOPS/GPU. Expected: 15-25% improvement.
#

# Parameters
#SBATCH --account=root
#SBATCH --exclusive
#SBATCH --job-name=nem15b_fp8_256gpu_exp2_tp2
#SBATCH --mem=0
#SBATCH --nodes=32
#SBATCH --ntasks-per-node=8
#SBATCH --open-mode=append
#SBATCH --output=/mnt/vast/johnson/llmb/workloads/pretrain_nemotron4-15b/experiments/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512_1776133053/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/sbatch_exp2_tp2_%j.out
...
# GBS=512, DP=128, MBS=2 => 2 microbatches per DP rank
export OVERRIDE_GBS=512
export OVERRIDE_NUM_TRAIN_SAMPLES=25600

# EXPERIMENT 2: TP=2, sequence_parallel=True
export OVERRIDE_TP=2
export OVERRIDE_SEQ_PARALLEL=1
