#!/bin/bash
#
# Nemotron4 15B BF16 - 64 GPUs (8 nodes)
...
#SBATCH --account=root
#SBATCH --exclusive
#SBATCH --job-name=nemotron4_15b_bf16_64gpu
#SBATCH --mem=0
#SBATCH --nodes=8
#SBATCH --ntasks-per-node=8
#SBATCH --open-mode=append
#SBATCH --output=/mnt/vast/johnson/llmb/workloads/pretrain_nemotron4-15b/experiments/pretrain_nemotron4_15b_bf16_gpus64_tp1_pp1_cp1_vp1_mbs2_gbs256/pretrain_nemotron4_15b_bf16_gpus64_tp1_pp1_cp1_vp1_mbs2_gbs256_1776121405/pretrain_nemotron4_15b_bf16_gpus64_tp1_pp1_cp1_vp1_mbs2_gbs256/sbatch_nemotron4_15b_bf16_64gpu_%j.out
...
# Command 1
srun --output /mnt/vast/johnson/llmb/workloads/pretrain_nemotron4-15b/experiments/pretrain_nemotron4_15b_bf16_gpus64_tp1_pp1_cp1_vp1_mbs2_gbs256/pretrain_nemotron4_15b_bf16_gpus64_tp1_pp1_cp1_vp1_mbs2_gbs256_1776121405/pretrain_nemotron4_15b_bf16_gpus64_tp1_pp1_cp1_vp1_mbs2_gbs256/log-nemotron4_15b_bf16_64gpu_%j_${SLURM_RESTART_COUNT:-0}.out \
  ...
  bash /nemo_run/scripts/pretrain_nemotron4_15b_bf16_gpus64_tp1_pp1_cp1_vp1_mbs2_gbs256.sh
