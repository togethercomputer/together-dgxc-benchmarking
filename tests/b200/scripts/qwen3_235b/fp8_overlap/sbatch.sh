#!/bin/bash
#
# Qwen3 235B A22B FP8 MX - Optimized v3: ALL optimizations
# Changes vs baseline:
#   1. CUDA graphs: --cuda_graph_impl=transformer_engine --cuda_graph_scope=moe_router,moe_preprocess
#   2. NCCL fixes: NCCL_SOCKET_IFNAME=bond0, IB HCA pinning
#   3. HybridEP MoE dispatcher
#   4. Re-enabled param gather overlap (was disabled for NaN - testing if it works with other fixes)
#   5. ulimit -n 1048576
# WARNING: May produce NaN grad norms due to param gather overlap with FP8 MX
#
