...
# OPTIMIZATION EXP 2: PP=8 + NVLS (intra-node collective acceleration)
# TP=1, PP=8, CP=1, EP=8, VP=4, MBS=1, GBS=8192, DP=32
# Change: NCCL_NVLS_ENABLE=1 (was 0 in baseline)
...
srun --output /mnt/vast/llmb_/workloads/pretrain_qwen3/experiments/pretrain_qwen3_235b_a22b_bf16_gpus256_tp1_pp8_cp1_vp4_ep8_mbs1_gbs8192/pretrain_qwen3_235b_a22b_bf16_gpus256_tp1_pp8_cp1_vp4_ep8_mbs1_gbs8192_1775789255/pretrain_qwen3_235b_a22b_bf16_gpus256_tp1_pp8_cp1_vp4_ep8_mbs1_gbs8192/log-bf16_pp8_nvls_%j_${SLURM_RESTART_COUNT:-0}.out --container-image /mnt/vast/llmb_/images/nvidia+nemo+26.02.00.sqsh --container-mounts /mnt/vast/llmb_/.cache/huggingface,/mnt/vast/llmb_/workloads/pretrain_qwen3/Megatron-Bridge/scripts/performance/run_script.py:/mnt/vast/llmb_/workloads/pretrain_qwen3/Megatron-Bridge/scripts/performance/run_script.py,/mnt/vast/llmb_/workloads/pretrain_qwen3/Megatron-Bridge/scripts/performance:/mnt/vast/llmb_/workloads/pretrain_qwen3/Megatron-Bridge/scripts/performance,/mnt/vast/llmb_/workloads/pretrain_qwen3/experiments/pretrain_qwen3_235b_a22b_bf16_gpus256_tp1_pp8_cp1_vp4_ep8_mbs1_gbs8192/pretrain_qwen3_235b_a22b_bf16_gpus256_tp1_pp8_cp1_vp4_ep8_mbs1_gbs8192_1775789255/pretrain_qwen3_235b_a22b_bf16_gpus256_tp1_pp8_cp1_vp4_ep8_mbs1_gbs8192:/nemo_run --container-workdir /nemo_run/code --wait=60 --kill-on-bad-exit=1 --mpi=pmi2 --no-container-mount-home --container-writable bash /nemo_run/opt_scripts/bf16_pp8_nvls.sh
