#!/bin/bash
#
# Qwen3 235B A22B FP8 MX - Optimized v2: CUDA graphs + NCCL fixes + hybridep
# Changes vs baseline:
...
#   3. HybridEP MoE dispatcher: model.moe_flex_dispatcher_backend=hybridep
#   4. ulimit -n 1048576 for 512-GPU scale
#
