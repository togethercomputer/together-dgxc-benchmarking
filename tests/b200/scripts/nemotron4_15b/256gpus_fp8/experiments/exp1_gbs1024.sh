#!/bin/bash
#
# Nemotron4 15B FP8 - 256 GPUs - EXPERIMENT 1: GBS=1024
# Rationale: With GBS=1024, each GPU processes 2 microbatches (MBS=2),
# enabling compute/comm overlap during gradient allreduce.
# Baseline (GBS=512): ~1,600 TFLOPS/GPU. Expected: 10-20% improvement.
#

# Parameters
#SBATCH --account=root
#SBATCH --exclusive
#SBATCH --job-name=nem15b_fp8_256gpu_exp1_gbs1024
#SBATCH --mem=0
#SBATCH --nodes=32
#SBATCH --ntasks-per-node=8
#SBATCH --open-mode=append
#SBATCH --output=/mnt/vast/johnson/llmb/workloads/pretrain_nemotron4-15b/experiments/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512_1776133053/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/sbatch_exp1_gbs1024_%j.out
...
# EXPERIMENT 1: GBS=1024 (2 microbatches per DP rank instead of 1)
...
# Command 1
srun --output /mnt/vast/johnson/llmb/workloads/pretrain_nemotron4-15b/experiments/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512_1776133053/pretrain_nemotron4_15b_fp8_gpus256_tp1_pp1_cp1_vp1_mbs2_gbs512/log-exp1_gbs1024_%j_${SLURM_RESTART_COUNT:-0}.out \
